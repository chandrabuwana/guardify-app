...
part 'edit_incident_request.g.dart';

/// Request model untuk Edit Incident API
@JsonSerializable()
class EditIncidentRequest {
  ...
  factory EditIncidentRequest.fromJson(Map<String, dynamic> json) =>
      _$EditIncidentRequestFromJson(json);

  Map<String, dynamic> toJson() => _$EditIncidentRequestToJson(this);
}
