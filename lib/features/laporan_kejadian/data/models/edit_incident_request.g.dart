...
part of 'edit_incident_request.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

EditIncidentRequest _$EditIncidentRequestFromJson(Map<String, dynamic> json) =>
    $checkedCreate(
      'EditIncidentRequest',
      json,
      ($checkedConvert) {
        final val = EditIncidentRequest(
          areasDescription:
...
Map<String, dynamic> _$EditIncidentRequestToJson(
        EditIncidentRequest instance) =>
    <String, dynamic>{
