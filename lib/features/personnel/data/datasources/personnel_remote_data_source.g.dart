...
class _PersonnelRemoteDataSource implements PersonnelRemoteDataSource {
  ...
  Future<PersonnelListResponseModel> getPersonnelList(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<PersonnelListResponseModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = PersonnelListResponseModel.fromJson(_result.data!);
    return value;
  }
  ...
  Future<PersonnelDetailResponseModel> getPersonnelById(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<PersonnelDetailResponseModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = PersonnelDetailResponseModel.fromJson(_result.data!);
    return value;
  }
