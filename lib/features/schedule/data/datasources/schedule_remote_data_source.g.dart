...
class _ScheduleApiClient implements ScheduleApiClient {
  ...
  @override
  Future<ShiftNowResponseModel> getShiftNow(Map<String, dynamic> body) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(body);
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ShiftNowResponseModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = ShiftNowResponseModel.fromJson(_result.data!);
    return value;
  }
